...
var _FeedDetailWidget_detail_FeedId    = '${detailFeedId}';
...
<c:choose>
  <c:when  test="${uiMode eq 'js'}">
	<script type="text/javascript" src="../jsx/build/sns/main/FeedDetailWidget.js"></script>
  </c:when >
  <c:otherwise>
	<script type="text/jsx" src="../jsx/src/sns/main/FeedDetailWidget.jsx"></script>
  </c:otherwise>
</c:choose>
