		var NormalFeedElement = React.createClass({
			...
			render: function() {
	        	return (
						<div ref='main_feed_area'>
                            <textarea onClick={this.props.textareaClick} style={{'width':'94%', 'padding':'1% 4% 2% 2%', 'height':'32px', 'borderBottom':'none', 'borderLeft':'none','borderRight':'none','borderTop':'none', 'resize':'none'}} className='feedContentsInput' id='feedContentsInput' ref='feedContents' placeholder={_FEED_NormalType_MSG_WHATRUWORKINGONMSG}></textarea>
		...
		var FeedModifyElement = React.createClass({
			...
			render: function() {
	        	return (
	        			<div>
							<div ref='modify_feed_area'>
                            	<textarea style={{'width':'99%', 'padding':'1% 4% 2% 2%', 'height':'32px', 'right':'10px', 'border':'1px solid #e0e0e0', 'resize':'none'}} className='modifyFeedContentsInput' id='modifyFeedContentsInput' ref='modifyFeedContentsInput'></textarea>
							</div>
							<div style={{'margin':'0px 7px 0 0px'}}>
								<button style={{'float':'right','cursor':'initial'}} type='button' id='feedUpdate' ref='feedUpdate' className='btn-m btn-m btn-attention' onClick={this.feedUpdate}>{_FEED_NormalType_UPDATEDBUTTON}</button>
