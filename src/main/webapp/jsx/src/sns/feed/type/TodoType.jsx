		var ToDoElement = React.createClass({
			...
			render: function() {
	        	return (
						<div>
                            <strong><input id='dueDate' ref='dueDate' style={{'color':'blue', 'fontWeight':'bold', 'width':'150px', 'padding':'10px 5% 10px 1%', 'marginBottom':'15px', 'borderBottom':'1px solid #e0e0e0'}} placeholder='' readOnly></input></strong>
                            <textarea onClick={this.props.textareaClick} style={{'width':'94%', 'padding':'1% 4% 2% 2%', 'border':'none', 'resize':'none'}}  cols='' rows='2' placeholder={_Todo_BASIC_TODO_TODOTEXTAREAMSG} className='feedContentsInput' id='feedContentsInput' ref='feedContents'></textarea>
                        	<span className='pp plus_file2' onClick={this.fileLayout}></span>
						</div>
	           	);
			}
		});