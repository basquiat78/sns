	...
	var Container = React.createClass({
		...
		getCurrMemberInfo : function(data) {
			...
			React.render(<SideNav mainType={'main'} currMemberInfo={this.props.currMemberInfo} />, document.getElementById('SideNav'));
			React.render(<MainContents mainType={'main'} detailFeedId={'0'}/>, document.getElementById('MainContents'));
			React.render(<RightContentArea mainType={'main'}/>, document.getElementById('RightContentArea'));
			React.render(<Container currMemberInfo={this.state.currMemberInfo} />, document.getElementById('Container'));
		},
		...
		render: function() {
	    	return (
				<div className='lay-container-wrap' style={{'height':'100%'}}>
					<div id='SideNav'></div>
			...
			switch (num) {
  				...
  				case 2 :
  						renderRightLevel(type, option); 
               			break;
  				case 3 : 
  						React.render(<MainContents mainType={MCtype} detailFeedId={'0'}/>, document.getElementById('MainContents'));
               			break;
			}		
		});
