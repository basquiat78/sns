	...
	var NoMyHeavenHere = React.createClass({displayName: "NoMyHeavenHere",
		render : function() {
			return (
...
var Group = React.createClass({displayName: "Group",
		...
		render: function() {
			...
			var lockIconWrapper = this.state.isPublic == 1
				? ''
				:
				React.createElement("span", {className: "ico-img ico-lock"}, "Lock")
				;
		
			if(this.state.isAutoJoin==0 && this.state.isGroupMng==1){
				return (
					React.createElement("li", {className: "nav-item"}, 
						React.createElement("span", {className: "nav-anchor my-group-item", id: myGroupId, rel: this.state.groupId, onClick: this.groupClickTest, style: {'cursor':'pointer'}}, 
							React.createElement("span", {className: "data-txt", ref: "dataTxt"}, this.state.groupName, lockIconWrapper, React.createElement("span", {className: "ico-img ico-master"}, "Master")), 
							React.createElement("span", {className: "data-num"}, this.state.newFeedCnt)
						)
					)
				);
				...
				return (
					React.createElement("li", {className: "nav-item"}, 
						React.createElement("span", {className: "nav-anchor my-group-item point-flag-class", id: myGroupId, rel: this.state.groupId, onClick: this.groupClickTest, style: {'cursor':'pointer'}}, 
							React.createElement("span", {className: "data-txt point-flag-class", ref: "dataTxt"}, this.state.groupName, lockIconWrapper), 
							React.createElement("span", {className: "data-num"}, this.state.newFeedCnt)
						)
					)
				);
				...
				return (
					React.createElement("li", {className: "nav-item"}, 
						React.createElement("span", {className: "nav-anchor my-group-item point-flag-class", id: myGroupId, rel: this.state.groupId, onClick: this.groupClickTest, style: {'cursor':'pointer'}}, 
							React.createElement("span", {className: "data-txt point-flag-class", ref: "dataTxt"}, this.state.groupName, React.createElement("span", {className: "ico-img ico-master"}, "Master")), 
							React.createElement("span", {className: "data-num"}, this.state.newFeedCnt)
						)
					)
				);
				...
				return (
					React.createElement("li", {className: "nav-item"}, 
						React.createElement("span", {className: "nav-anchor my-group-item point-flag-class", id: myGroupId, rel: this.state.groupId, onClick: this.groupClickTest, style: {'cursor':'pointer'}}, 
							React.createElement("span", {className: "data-txt point-flag-class", ref: "dataTxt"}, this.state.groupName), 
							React.createElement("span", {className: "data-num"}, this.state.newFeedCnt)
						)
					)
				);
	...
	//SideNav 나의그룹
	var MyGroup  = React.createClass({displayName: "MyGroup",
		getInitialState : function () {
		...
		createGroup: function(){
			...
			var ftype = 'normal';
			React.render(React.createElement(FollowerApp, {fromFollowerInputSetting: that.fromFollowerInputSetting, writtenFollowerList: [], fromFollowrSetting: that.fromFollowrSetting, followerHandler: that.followerHandler, ftype: ftype})
		...
		groupSearch: function(){
			React.render(React.createElement(GroupSearchList, null), document.getElementById('GroupSearchPopup'));
		...
		getMygroupListResult : function(data, option){
			var groupNode = data.map(
				function (ctl) {
					...
					return (
						React.createElement(Group, {key: key, data: ctl})
					);
				}
			);
			...
			if(data.length == 0) {
				...
				React.render(React.createElement(NoMyHeavenHere, null), document.getElementById('noMyHeavenHere'));
			}
		},
		...
		render: function() {
	    	...
	    	return (
				React.createElement("div", null, 
					React.createElement("nav", {className: "nav-lnb"}, 
						React.createElement("ul", {className: "nav-lnb-root"}, 
							React.createElement("li", {className: "nav-item"}, React.createElement("a", {className: "nav-anchor", onClick: this.hoverFolder}, _Group_spring_message_basic_mygroup, React.createElement("span", {className: "ico-img ico-folding", id: "icoFolding"})), 
								React.createElement("ul", {className: "nav-lnb-sub active", style: {'overflow':'hidden'}}, 
					...
					React.createElement("div", {className: "sub-function"}, 
                		React.createElement("div", {className: "sub-function-item", onClick: this.createGroup, style: {'cursor':'pointer'}}, React.createElement("span", {className: "group-create"}, _Group_spring_message_basic_group_create, React.createElement("span", {className: "ico-img ico-plus"}, "Plus"))), 
                		React.createElement("div", {className: "sub-function-item", onClick: this.groupSearch, style: {'cursor':'pointer'}}, React.createElement("span", {className: "group-search"}, _Group_spring_message_basic_group_find, React.createElement("span", {className: "ico-img ico-search"}, "Search")))
                	)
				)
			);
		}
...
function getGroupDetailResult(groupdata){
		...
		// 오른쪽 메뉴 상단 그룹 팔로워 리스트
	React.unmountComponentAtNode(document.getElementById('RightUpLevel'));
	React.render(React.createElement(MyGroupFollower, {groupId: groupdata.groupId}), document.getElementById('RightUpLevel'));
		...
		// 가운데 컨텐츠 상단 부분(그룹 정보)
		React.unmountComponentAtNode(document.getElementById('head_contents'));
		React.render(React.createElement(GroupHead, {groupId: groupdata.groupId}), document.getElementById('head_contents'));


		// 가운데 컨텐츠 상단 부분(그룹 정보)
		React.unmountComponentAtNode(document.getElementById('mainContentsArea'));
		React.render(React.createElement(FeedApp, {groupInfo: groupdata}), document.getElementById('mainContentsArea'));


		// 중하단 탭 리스트 및 피드
		React.unmountComponentAtNode(document.getElementById('selectTabBySession'));
		React.render(React.createElement(GroupTabList, {groupId: groupdata.groupId, groupInfo: groupdata}),  document.getElementById('selectTabBySession'));
