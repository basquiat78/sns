		var MainFeedDropzoneComponent = React.createClass({displayName: "MainFeedDropzoneComponent",
    		...
    		componentDidMount: function () {
				...
				React.render(React.createElement(NormalFeedElement, {btnElement: btnElement, ogSetting: this.ogSetting, targetInfoList: this.state.targetInfoList, fromGroupInfo: this.props.fromGroupInfo, addFollowerList: this.addFollowerList, textareaClick: this.textareaClick, fileLayout: this.fileLayout}), document.getElementById('feedElementDiv'));
				React.render(React.createElement(FollowerApp, {dropFollowerSetting: this.dropFollowerSetting, removeDropFollower: this.removeDropFollower, fromFollowerInputSetting: this.fromFollowerInputSetting, writtenFollowerList: [], fromFollowrSetting: this.fromFollowrSetting, followerHandler: this.followerHandler}), document.getElementById('followerApp'));
				React.render(React.createElement(TagApp, {tagHandler: this.tagHandler}), document.getElementById('tagApp'));
    		},
			...
			updateFeed: function() {
				...
				var btnElement = $(React.findDOMNode(this.refs.postup));
				React.unmountComponentAtNode(document.getElementById('feedElementDiv'));
				React.render(React.createElement(NormalFeedElement, {btnElement: btnElement, keepContents: keepContents, ogSetting: this.ogSetting, targetInfoList: this.state.targetInfoList, fromGroupInfo: this.props.fromGroupInfo, addFollowerList: this.addFollowerList, textareaClick: this.textareaClick, fileLayout: this.fileLayout}), document.getElementById('feedElementDiv'));
			...
			feedToDo: function() {
				...
				var btnElement = $(React.findDOMNode(this.refs.postup));
				React.unmountComponentAtNode(document.getElementById('feedElementDiv'));
				React.render(React.createElement(ToDoElement, {keepContents: keepContents, btnElement: btnElement, targetInfoList: this.state.targetInfoList, fromGroupInfo: this.props.fromGroupInfo, addFollowerList: this.addFollowerList, textareaClick: this.textareaClick, fileLayout: this.fileLayout}), document.getElementById('feedElementDiv'));
				$(React.findDOMNode(this.refs.postup)).css('cursor','initial').removeClass('btn-attention').addClass('btn-default').show();
				$('.showApp').show();
			...
			feedSurvey: function() {
				...
				var btnElement = $(React.findDOMNode(this.refs.postup));
				React.unmountComponentAtNode(document.getElementById('feedElementDiv'));
				React.render(React.createElement(PullElement, {btnElement: btnElement, keepContents: keepContents, targetInfoList: this.state.targetInfoList, fromGroupInfo: this.props.fromGroupInfo, addFollowerList: this.addFollowerList, textareaClick: this.textareaClick, fileLayout: this.fileLayout}), document.getElementById('feedElementDiv'));
				$(React.findDOMNode(this.refs.postup)).css('cursor','initial').removeClass('btn-attention').addClass('btn-default').show();
				$('.showApp').show();
			},
			...
			feedNotice: function() {
				...
				var btnElement = $(React.findDOMNode(this.refs.postup));
				React.unmountComponentAtNode(document.getElementById('feedElementDiv'));
				React.render(React.createElement(NoticeElement, {btnElement: btnElement, keepContents: keepContents, targetInfoList: this.state.targetInfoList, fromGroupInfo: this.props.fromGroupInfo, addFollowerList: this.addFollowerList, textareaClick: this.textareaClick, titleContentsSetting: this.titleContentsSetting, fileLayout: this.fileLayout}), document.getElementById('feedElementDiv'));
				$(React.findDOMNode(this.refs.postup)).css('cursor','initial').removeClass('btn-attention').addClass('btn-default').show();
				$('.showApp').show();
			},
	    	...
	    	render: function () {
				...
				return (
						React.createElement("div", {className: "drag-area plus_title"}, 
							React.createElement("div", {className: "feed_select2", id: "selectFileLayout", style: {'display':'none'}}, 
                        		React.createElement("ul", null, 
                            		React.createElement("li", {onClick: this.uploadPcToSns, className: "icon_fs fileClass"}, React.createElement("img", {src: "../images/btn_snssave.png", width: "14", height: "16"})), 
                                	React.createElement("li", {onClick: this.uploadPcToSns, className: "txt_fs fileClass"}, Feed_Dropzone_MSG_CHOOSEFILEFROMPC, React.createElement("input", {type: "hidden", id: "mainAttach"})), 
                                	React.createElement("li", {onClick: this.uploadFromSharePoint, style: {'marginTop':'0'}, className: "nextline icon_fs"}, React.createElement("img", {src: "../images/btn_share.png", width: "16", height: "16"})), 
                                	React.createElement("li", {onClick: this.uploadFromSharePoint, className: "txt_fs2"}, Feed_Dropzone_MSG_CHOOSEFILEFROMSP)
                        		)
                        	), 
                        	React.createElement("div", {className: "feed_tab"}, 
		                        React.createElement("ul", null, 
		                        	React.createElement("li", {className: "icon_update_on update", onClick: this.updateFeed}, React.createElement("span", {className: "onHover"}, Feed_Dropzone_MSG_FEEDTABNEWFEEDTEXT)), 
	                                React.createElement("li", {className: "icon_feeddoing_off doing", onClick: this.feedToDo}, React.createElement("span", null, Feed_Dropzone_MSG_FEEDTABTODOTEXT)), 
	                                React.createElement("li", {className: "icon_feedsurvay_off survay", onClick: this.feedSurvey}, React.createElement("span", {className: "ifs_off"}, Feed_Dropzone_MSG_FEEDTABPOLLTEXT))
	                        	)
                        	), 
							React.createElement("div", {id: "feedElementDiv", className: "feedElementDiv", ref: "feedElementDiv", style: {'clear':'both'}}), 

							React.createElement("div", {className: "feed_select hidden", style: {'display':'none'}}, 
       							React.createElement("ul", null, 
            						React.createElement("li", {className: "icon_fs"}, React.createElement("img", {src: "../images/icon_doregister.gif", width: "16", height: "15"})), 
               						React.createElement("li", {className: "txt_fs ignore", onClick: this.clickEvent}, 
										React.createElement("input", {type: "hidden", id: "datepicker"}), 
 										React.createElement("div", {className: "trigger"}, Feed_Dropzone_MSG_REGISTERTODO)
									), 
									React.createElement("li", {style: {'marginTop':'0'}, className: "nextline icon_fs"}, React.createElement("img", {src: "../images/icon_survay.png", width: "16", height: "16"})), 
                                   	React.createElement("li", {className: "txt_fs2"}, Feed_Dropzone_MSG_REGISTERPOLL), 
	           						React.createElement("li", {className: "nextline icon_fs", style: {'marginTop': '0px'}}, React.createElement("img", {src: "../images/icon_notice.gif", width: "16", height: "14"})), 
									React.createElement("li", {className: "txt_fs2"}, Feed_Dropzone_MSG_REGISTERNOTI)
	       						)
	       					), 

							React.createElement("div", {id: "ogArea"}), 
							React.createElement("div", {id: "file_preview"}), 
							React.createElement("div", {id: "followerApp", className: "showApp", style: {'borderTop':'1px solid #e0e0e0'}}), 
							React.createElement("div", {id: "tagApp", className: "showApp"}), 
							React.createElement("div", {className: "buttonWrapper showApp", style: {'display':'none', 'textAlign':'right', 'background':'#f5f5f5', 'height':'39px', 'paddingRight':'18px', 'borderTop':'none'}, ref: "mainAddButton"}, 
								React.createElement("span", {className: "icon_tag2", onClick: this.showTag}), 
								React.createElement("button", {style: {'float':'right', 'marginTop':'5px', 'cursor':'initial'}, type: "button", id: "addFeed", ref: "postup", className: "btn-m btn-default", onClick: this.feedAdd}, Feed_Dropzone_MSG_FEEDWRITEBTNTEXT)
							)
						)
	        		);
	    		},
		...
		var CommentDropzoneComponent = React.createClass({displayName: "CommentDropzoneComponent",
    		getDjsConfig: function () {
...
/**/
				...
				React.render(React.createElement(CommentFollowerApp, {pFeedId: this.props.feedId, 
			...
			OGTrigger: function(data) {
				...
				var showRemove = 'true';
				React.render(React.createElement(CommentOG, {data: data, removeOG: this.removeOGTag, showRemove: showRemove}), document.getElementById(commentOgId));
			},
			...
			render: function() {
				...
				return (
						React.createElement("div", {className: "my_opinion", style: opinionStyle}, 
							React.createElement("input", {type: "hidden", ref: "pFeedId", value: this.props.feedId}), 
							React.createElement("input", {type: "hidden", ref: "contentsType", value: "COMMENT"}), 

							React.createElement("span", {className: "answer_peo", id: answerTagId}), 
							
               				React.createElement("div", {className: "big_wrap"}, 
               				
	               				React.createElement("span", {className: "pic_small", ref: "commentPicture"}, "pic"), 
	               				React.createElement("div", {className: "add_peo commentff feed_comment", ref: "commentff", style: {'overflow':'hidden', 'marginRight':'0px'}}, 
									React.createElement("div", {style: {'border':'1px solid #e0e0e0', 'background':'#ffffff'}, ref: "comment_feed_area"}, 
										React.createElement("textarea", {id: this.props.commentId, onClick: this.textclick, style: {'border':'currentColor', 'borderImage':'none', 'width':'100%', 'height':'20px', 'overflow':'hidden', 'resize':'none'}, cols: "", rows: "", ref: "feedContents", placeholder: Feed_Dropzone_MSG_COMMENTAREADEFAULTMSG})
									)
								), 
								React.createElement("span", {className: "cliparea", id: pppId, onClick: this.fileLayout}), 
                                React.createElement("div", {id: previewsContainerId}), 
	           					React.createElement("div", {className: "add_peo", style: {'borderBottom':'none', 'marginLeft':'54px', 'paddingTop':'0'}}, 
									React.createElement("div", {id: commentOgId})
	      						), 
								React.createElement("div", {id: cfId, className: "width100", style: {'marginLeft':'45px', 'display':'none'}, ref: "commentFollowerArea"})
							), 
								

							React.createElement("div", {className: "feed_select3", id: subFileLayout, style: {'display':'none'}}, 
                            	React.createElement("ul", null, 
                                	React.createElement("li", {onClick: this.uploadPcToSns, className: "icon_fs"}, React.createElement("img", {src: "../images/btn_snssave.png", width: "14", height: "16"})), 
                                    React.createElement("li", {onClick: this.uploadPcToSns, ref: "subAttatchId", className: "txt_fs subFileClass"}, Feed_Dropzone_MSG_CHOOSEFILEFROMPC, React.createElement("input", {type: "hidden", id: clickAreaId})), 
                                    React.createElement("li", {onClick: this.uploadFromSharePoint, style: {'marginTop':'2px'}, className: "nextline icon_fs"}, React.createElement("img", {src: "../images/btn_share.png", width: "16", height: "16"})), 
                                    React.createElement("li", {onClick: this.uploadFromSharePoint, className: "txt_fs2 subFileClass"}, Feed_Dropzone_MSG_CHOOSEFILEFROMSP)
                                )
                            ), 
							React.createElement("div", {className: "buttonWrapper", id: subButtonLayout, style: {'display':'none', 'textAlign':'right','marginTop':'10px'}, ref: "commentButtonArea"}, 
								React.createElement("button", {style: {'cursor':'initial', 'marginTop':'0px', 'marginBottom':'0px'}, type: "button", id: this.props.addCommentId, ref: "postup", className: "btn-m btn-default", onClick: this.feedAdd}, Feed_Dropzone_MSG_FEEDWRITEBTNTEXT)
							)
						)
	        	);
		...
		var ShareFeedDropzoneComponent = React.createClass({displayName: "ShareFeedDropzoneComponent",
    		...
    		componentDidMount: function () {
				...
				React.render(React.createElement(ShareFollowerApp, {fromFollowerInputSetting: this.fromFollowerInputSetting, writtenFollowerList: this.state.writtenFollowerList, fromFollowrSetting: this.fromFollowrSetting, followerHandler: this.followerHandler}), document.getElementById('shareFollowerApp'));
    		},
	    	...
	    	render: function () {
				...
				return (
						React.createElement("div", {className: "drag-area"}, 
							React.createElement("div", {className: "share_select", id: "shareSelectFileLayout", style: {'display':'none'}}, 
                        		React.createElement("ul", null, 
                            		React.createElement("li", {onClick: this.uploadPcToSns, className: "icon_fs shareFileClass"}, React.createElement("img", {src: "../images/btn_snssave.png", width: "14", height: "16"})), 
                                	React.createElement("li", {onClick: this.uploadPcToSns, className: "txt_fs shareFileClass"}, Feed_Dropzone_MSG_CHOOSEFILEFROMPC, React.createElement("input", {type: "hidden", id: "mainAttachShpPop"})), 
                                	React.createElement("li", {onClick: this.uploadFromSharePoint, style: {'marginTop':'0'}, className: "nextline icon_fs"}, React.createElement("img", {src: "../images/btn_share.png", width: "16", height: "16"})), 
                                	React.createElement("li", {onClick: this.uploadFromSharePoint, className: "txt_fs2"}, Feed_Dropzone_MSG_CHOOSEFILEFROMSP)
                        		)
                        	), 
							React.createElement("div", {className: "ff", id: "shareArea"}, 
								React.createElement("div", {id: "feedElementDiv", style: {'clear':'both'}}, 
                            		React.createElement("span", {onClick: this.fileLayout, className: "sharepp"}, React.createElement("img", {src: "../images/plus_file_on.png", width: "43", height: "42"})), 
                            		React.createElement("textarea", {style: {'width':'90%', 'padding':'10px 5%', 'border':'1px solid #e0e0e0', 'resize':'none'}, className: "shareContentsInput", id: "shareContentsInput", ref: "shareContents"})
								), 
								React.createElement("div", {className: "add_file_wrap"}, 
									React.createElement("div", {id: "file_previewShp"}), 
									React.createElement("div", {id: "shareFollowerApp"})
								), 
								React.createElement("div", {className: "buttonWrapper"}, 
									React.createElement("button", {style: {'float':'right', 'cursor':'initial', 'marginTop':'5px'}, type: "button", id: "addShare", ref: "shareup", className: "btn-m btn-default", onClick: this.shareFeed}, Feed_Dropzone_MSG_SHAREBTNTEXT)
								)
							)
						)
	        		);
		...
		var MessageFeedDropzoneComponent = React.createClass({displayName: "MessageFeedDropzoneComponent",
				...
				return (
						React.createElement("div", {className: "drag-area"}, 
							React.createElement("div", {className: "feed_select2", id: "selectFileLayout", style: {'display':'none'}}, 
                        		React.createElement("ul", null, 
                            		React.createElement("li", {onClick: this.uploadPcToSns, className: "icon_fs fileClass"}, React.createElement("img", {src: "../images/btn_snssave.png", width: "14", height: "16"})), 
                                	React.createElement("li", {onClick: this.uploadPcToSns, className: "txt_fs fileClass"}, Feed_Dropzone_MSG_CHOOSEFILEFROMPC, React.createElement("input", {type: "hidden", id: "sendAttach"})), 
                                	React.createElement("li", {onClick: this.uploadFromSharePoint, style: {'marginTop':'0'}, className: "nextline icon_fs"}, React.createElement("img", {src: "../images/btn_share.png", width: "16", height: "16"})), 
                                	React.createElement("li", {onClick: this.uploadFromSharePoint, className: "txt_fs2"}, Feed_Dropzone_MSG_CHOOSEFILEFROMSP)
                        		)
                        	), 
							React.createElement("div", {className: "ff", id: "sendFeedArea"}, 
								React.createElement("div", {id: "feedElementDiv", className: "feedElementDiv", ref: "feedElementDiv", style: {'clear':'both'}}
								), 
								React.createElement("div", {className: "feed_select hidden", style: {'display':'none'}}, 
	        							React.createElement("ul", null, 
											...
											React.createElement("li", {style: {'marginTop':'2px'}, className: "nextline icon_fs"}, React.createElement("img", {src: "../images/icon_survay.png", width: "16", height: "16"})), 
                                        	React.createElement("li", {className: "txt_fs2"}, Feed_Dropzone_MSG_REGISTERPOLL), 
	                						React.createElement("li", {className: "nextline icon_fs", style: {'marginTop': '0px'}}, React.createElement("img", {src: "../images/icon_notice.gif", width: "16", height: "14"})), 
											React.createElement("li", {className: "txt_fs2"}, Feed_Dropzone_MSG_REGISTERNOTI)
	            						)
	        					), 
								React.createElement("div", {className: "add_file_wrap hide-area"}, 
									React.createElement("div", {id: "ogArea"}), 
									React.createElement("div", {id: "file_preview"}), 
									React.createElement("div", {id: "followerApp"}), 
									React.createElement("div", {id: "tagApp"})
								), 
								React.createElement("div", {className: "buttonWrapper"}, 
									React.createElement("button", {style: {'float':'right', 'cursor':'initial'}, type: "button", id: "addFeed", ref: "postup", className: "btn-m btn-default", onClick: this.feedAdd}, Feed_Dropzone_MSG_FEEDWRITEBTNTEXT)
								)
							)
						)
	        		);
