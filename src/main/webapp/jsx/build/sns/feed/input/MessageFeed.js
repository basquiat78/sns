		var SendMessagePop = React.createClass({displayName: "SendMessagePop",
			...
			render: function() {
	        	...
	        	return (
						React.createElement("div", null, 
							...
							React.createElement("h3", null, message, React.createElement("span", {className: "btn_close"}, React.createElement("img", {src: "../images/btn_close.png", width: "13", height: "13", onClick: this.sendMessageClosePopup}))), 
       						React.createElement("div", {className: "share_area_wrap"}, 
