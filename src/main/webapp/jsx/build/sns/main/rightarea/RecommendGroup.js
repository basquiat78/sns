...
var RecommendGroupOne = React.createClass({displayName: "RecommendGroupOne",
		...
		render : function() {
			...
			return (
				React.createElement("dl", {className: "recommand_group"}, 
                    ...
                    React.createElement("dd", {className: "per_email line_space", style: {'color':'#999999','marginLeft':'54px'}}, regdate, React.createElement("span", {style: {'marginLeft':'17px'}}, "Member ", React.createElement("strong", {className: "txt_point", style: {'color':'#333', 'cursor':'pointer'}}, this.state.memberCnt)))
                )		
			);
		}
	});
	
	var RecommendGroupList = React.createClass({displayName: "RecommendGroupList",
		...
		render : function() {
			var recommendGroupNodes = this.props.data.map(function (group, index) {
				return (
					React.createElement(RecommendGroupOne, {key: index, groupId: group.groupId, groupName: group.groupName, groupImgUrl: group.groupImgUrl, regMemberName: group.regMemberName, 
	...
	var RecommendGroup  = React.createClass({displayName: "RecommendGroup",
	    	...
	    	return (
					React.createElement("div", null, 
                        React.createElement("dl", {className: "rightarea_gate", style: {'marginTop':'0', 'marginBottom':'0'}}, 
                            React.createElement("dt", {className: "malgun13"}, _RecommendGroup_MSG_RECOMMENDGROUPTITLE), 
                        ...
                        React.createElement(RecommendGroupList, {data: this.state.data})
                    )
			);
		}
	});