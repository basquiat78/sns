		...
		var MemberHead = React.createClass({displayName: "MemberHead",
			...
			render: function() {
				...
				return (
       	 	    	React.createElement("dl", null, 
	       				React.createElement("dt", {className: "pic_big", id: "member_pic_big", rel: tooltipInfo, style: {'cursor':'pointer','borderRadius':'50%'}, ref: "ffImg", onMouseOver: this.openLyncMenuImg, onMouseOut: this.hideLyncMenu}, "pic"), 	
                        React.createElement("dd", {className: "malgun22 left_space"}, React.createElement("span", {className: "headTooltipPop", rel: tooltipInfo, ref: "ffName", onMouseOver: this.openLyncMenuName, onMouseOut: this.hideLyncMenu}, this.state.memberName, " ", this.state.memberPosition)), 
                        React.createElement("dd", null, React.createElement("span", {className: "join_icon"}, this.state.memberPartName))
           			)
	        	);
	        }
		});

		var GroupHead = React.createClass({displayName: "GroupHead",
			...
			tooltipRender: function(data) {
				React.render(React.createElement(FollowerTooltip, {followerInfo: data, itemId: 'group'}), document.getElementById('sns-tooltip'));
				this.tooltipPosition();
			},
			...
			render: function() {
				...
				? React.createElement("dd", {className: "icon_set left_space", title: "설정", onClick: this.openGroupConfigPop}, "설정")
				: '';
				...
				if(joinStatusTEXT == _HeadInfo_MSG_JOINSTATUSSTANDBY || joinStatusTEXT == _HeadInfo_MSG_JOINSTATUSYES){
					return (
		       	 	    	React.createElement("dl", {className: "header-group", style: {'marginRight':'40px'}}, 
			       				React.createElement("dt", {className: "pic_group_big groupTooltipPop", id: "group_pic_big", rel: tooltipInfo, style: {'cursor':'pointer'}}, "pic"), 	
		                        React.createElement("dd", {className: "malgun22 left_space", style: {'whiteSpace':'nowrap', 'textOverflow':'ellipsis', 'overflow':'hidden'}}, 
		                        	React.createElement("span", {rel: tooltipInfo, className: "groupTooltipPop"}, this.state.groupName)), 
		                        groupConfigBtn, 
		                        React.createElement("dd", {className: "fg_explan left_space"}, description), 
		                        React.createElement("dd", {className: "fg_belong left_space"}, this.state.isPublic, "| "), 
		                        React.createElement("dd", {className: "join_icon", onClick: this.joinout}, React.createElement("img", {src: "../images/icon_check.gif", style: {"width":"11", "height":"11"}})), 
		                       	React.createElement("dd", {className: "btn_fgjoin", onClick: this.joinout}, joinStatusTEXT)
		           			)
		      	    );
		      		...
		      		return (
		       	 	    	React.createElement("dl", {className: "header-group", style: {'marginRight':'40px'}}, 
			       				React.createElement("dt", {className: "pic_group_big groupTooltipPop", id: "group_pic_big", rel: tooltipInfo, style: {'cursor':'pointer'}}, "pic"), 	
		                        React.createElement("dd", {className: "malgun22 left_space", style: {'whiteSpace':'nowrap', 'textOverflow':'ellipsis', 'overflow':'hidden'}}, React.createElement("span", {rel: tooltipInfo, className: "groupTooltipPop"}, this.state.groupName)), 
		                        groupConfigBtn, 
		                        React.createElement("dd", {className: "fg_explan left_space"}, description), 
		                        React.createElement("dd", {className: "fg_belong left_space"}, this.state.isPublic, "| "), 
		                        React.createElement("dd", {className: "join_icon", onClick: this.joinout}, React.createElement("img", {src: "../images/icon_check.gif", style: {"width":"11", "height":"11"}})), 
		                       	React.createElement("dd", {className: "btn_fgjoin", onClick: this.rejoin}, joinStatusTEXT)
		           			)
		      	    );
		      	} else {
					return (
		                        ...
		                        React.createElement("dd", {className: "fg_explan left_space"}, description), 
		                        React.createElement("dd", {className: "fg_belong left_space"}, this.state.isPublic, "| "), 
		                        React.createElement("dd", {className: "nojoin_icon", onClick: this.join}, React.createElement("img", {src: "../images/icon_check.gif", style: {"width":"11", "height":"11"}})), 
		                       	React.createElement("dd", {className: "btn_fgjoin", onClick: this.join}, joinStatusTEXT)
		           			)
		      	    );
				}
	       	}
