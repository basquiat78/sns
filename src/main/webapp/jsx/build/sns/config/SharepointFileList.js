		...
		var SharepointFile  = React.createClass({displayName: "SharepointFile",
			...
			goSharepointFileList: function() {
				var path = this.props.path;
 				var url = contextpath + "/openapi/sharepoint/site/info?UserID=" + _SharepointFileList_USERID + "&SiteType=" + _SharepointFileList_SITETYPE + "&path=" + path;
				...
				$("#tree").dynatree({
					...
					onLazyRead: function(node){
						...
						var lazyUrl = contextpath + "/openapi/sharepoint/folder/info/" + path + "?UserID=" + _SharepointFileList_USERID + "&SiteID=" + siteId + "&FolderId=" + folderId + "&checkUseYn=N";
						node.appendAjax({
							url: lazyUrl,
							success: function(nd) {
								nd.visit(function(n){
			...
			render: function() {
				return (
		     	     ...
		     	     React.createElement("div", {className: "share_area_wrap", style: {'border':'0px', 'width':'994px', 'height':'526px'}}, 
		                React.createElement("div", {className: "left_layer_wrap"}, 
		                    React.createElement("div", {className: "left_layer", style: {'height':'500px'}}, 
		                    	React.createElement("div", {style: {'height':'490px'}, id: "tree"})
		                    )
		                ), 
		                React.createElement("div", {className: "right_layer_wrap"}, 
		                    React.createElement("div", {className: "right_layer", style: {'height':'500px'}}, 
		                        React.createElement("span", null, React.createElement("input", {id: "shpPopFind", name: "shpPopFind", type: "text", placeholder: "Find"})), 
		               			React.createElement("table", {width: "673px", border: "0", cellSpacing: "0", cellPadding: "0"}, 
		                          ...
		                          React.createElement("thead", null, 
		                              React.createElement("tr", null, 
		                                React.createElement("th", {scope: "col"}, _SharepointFileList_MSG_COLUMN1TEXT), 
		                                React.createElement("th", {scope: "col"}, _SharepointFileList_MSG_COLUMN2TEXT), 
		                                React.createElement("th", {scope: "col"}, _SharepointFileList_MSG_COLUMN3TEXT), 
		                                React.createElement("th", {scope: "col", style: {"border-right":"none"}}, _SharepointFileList_MSG_COLUMN4TEXT)
		                              )
		                          )
		                        ), 
		               			React.createElement("div", {id: "shpFileRightDivLayer", className: "table_wrap", style: {"height":"427px", "overflow":"auto"}}, 
		                            React.createElement("table", {id: "shpFileTab", width: "0", border: "0", cellSpacing: "0", cellPadding: "0", style: {"borderTop":"none"}}, 
		                              React.createElement("caption", null), 
		                              React.createElement("colGroup", null, 
		                                React.createElement("col", {width: "10%"}), 
		                                React.createElement("col", {width: "*"}), 
		...
		function openSharepointFilePop(shpFileHiddenId) {
			...
			var path = "FOLDER";
			React.render(React.createElement(SharepointFile, {path: path}), document.getElementById('SharepointFilePopup'));
...
//					}
		...
		function setShpFileNodeInfo(node) {
			...
			$.ajax({
				  url : contextpath + "/openapi/sharepoint/if_sv_005",
