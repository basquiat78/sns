...
function UniteGalleryMain(){
	...
	var g_options = {				
			...
			gallery_move_id:""							// after Closing Fullscreen, move To open Div
	};
	...
	this.setFullScreenToggleButton = function(objButton){
		...
		g_objGallery.on(t.events.EXIT_FULLSCREEN,function(){
			...
			window.scroll(0, this.getOffsetTop(document.getElementById(g_options.gallery_move_id)));
		});
	...
	function toFakeFullScreen(){
		...
		/*$(document).keyup(function(e){
			 if (e.which == 27 || e.keyCode == 27) { //deactivateUGFullScreen(); 
